...
class RefriEnv(Env):
    ...
    def step(self, action):
        ...
        cool_state=(self.P_cool*self.E-self.U*self.A*(self.state-self.T_ext)+O*self.h*(self.T_ext-self.state))/(self.m*self.c)
        normal_state=(-self.U*self.A*(self.state-self.T_ext)+O*self.h*(self.T_ext-self.state))/(self.m*self.c)
        # Apply action
        #DR이 발생되었을 때의 처리
